package com.jwj.demo.androidapidemo.custom_view.refresh.impl;
...
import static com.jwj.demo.androidapidemo.custom_view.refresh.util.ScrollBoundaryUtil.canScrollDown;
import static com.jwj.demo.androidapidemo.custom_view.refresh.util.ScrollBoundaryUtil.isTransformedTouchPointInView;
...
public class RefreshContentWrapper implements RefreshContent {
    ...
    public void setScrollBoundaryDecider(ScrollBoundaryDecider boundary) {
        if (boundary instanceof com.jwj.demo.androidapidemo.custom_view.refresh.impl.ScrollBoundaryDeciderAdapter) {
                    ...
                    try {
                        if (mScrollableView instanceof ListView) {
                            if (Build.VERSION.SDK_INT >= 19) {
                                ((ListView) com.jwj.demo.androidapidemo.custom_view.refresh.impl.RefreshContentWrapper.this.mScrollableView).scrollListBy(value - lastValue);
                            } else {
//                                ListViewCompat.scrollListBy((ListView) mScrollableView, value - lastValue);
                                ListView listView = (ListView) com.jwj.demo.androidapidemo.custom_view.refresh.impl.RefreshContentWrapper.this.mScrollableView;
